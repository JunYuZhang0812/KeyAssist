...
public class KeyCode //系统枚举Keys的值
{
    public const int KEY_LBUTTON = 0x0001; //鼠标左键
    public const int KEY_RBUTTON = 0x0002; //鼠标右键
    public const int KEY_CANCEL = 0x0003;  //CANCEL键
    public const int KEY_MBUTTON = 0x0004; //鼠标中键

    //常用功能键
    public const int KEY_BACK = 0x0008;
    public const int KEY_TAB = 0x0009;
    public const int KEY_ENTER = 0x000D;
    public const int KEY_SHIFT = 0x0010;
    public const int KEY_CTRL = 0x0011;
    public const int KEY_CAPS_LOCK = 0x0014;
    public const int KEY_ESC = 0x0018;
    public const int KEY_SPACE = 0x0020;
    public const int KEY_PAGE_UP = 0x0021;
    public const int KEY_PAGE_DOWN = 0x0022;
    public const int KEY_END = 0x0023;
    public const int KEY_NUMLOCK = 0x0090;

    //方向键
    public const int KEY_LEFT_ARROW = 0x0025;
    public const int KEY_UP_ARROW = 0x0026;
    public const int KEY_RIGHT_ARROW = 0x0027;
    public const int KEY_DOWN_ARROW = 0x0028;

    public const int KEY_PRINT = 0x002A;
    public const int KEY_DELETE = 0x002E;

    //0-9
    public const int KEY_0 = 0x0030;
    public const int KEY_1 = 0x0031;
    public const int KEY_2 = 0x0032;
    public const int KEY_3 = 0x0033;
    public const int KEY_4 = 0x0034;
    public const int KEY_5 = 0x0035;
    public const int KEY_6 = 0x0036;
    public const int KEY_7 = 0x0037;
    public const int KEY_8 = 0x0038;
    public const int KEY_9 = 0x0039;

    //A-Z
    public const int KEY_A = 0x0041;
    public const int KEY_B = 0x0042;
    public const int KEY_C = 0x0043;
    public const int KEY_D = 0x0044;
    public const int KEY_E = 0x0045;
    public const int KEY_F = 0x0046;
    public const int KEY_G = 0x0047;
    public const int KEY_H = 0x0048;
    public const int KEY_I = 0x0049;
    public const int KEY_J = 0x004A;
    public const int KEY_K = 0x004B;
    public const int KEY_L = 0x004C;
    public const int KEY_M = 0x004D;
    public const int KEY_N = 0x004E;
    public const int KEY_O = 0x004F;
    public const int KEY_P = 0x0050;
    public const int KEY_Q = 0x0051;
    public const int KEY_R = 0x0052;
    public const int KEY_S = 0x0053;
    public const int KEY_T = 0x0054;
    public const int KEY_U = 0x0055;
    public const int KEY_V = 0x0056;
    public const int KEY_W = 0x0057;
    public const int KEY_X = 0x0058;
    public const int KEY_Y = 0x0059;
    public const int KEY_Z = 0x005A;

    //小键盘
    public const int KEY_NUMPAD0 = 0x0060;
    public const int KEY_NUMPAD1 = 0x0061;
    public const int KEY_NUMPAD2 = 0x0062;
    public const int KEY_NUMPAD3 = 0x0063;
    public const int KEY_NUMPAD4 = 0x0064;
    public const int KEY_NUMPAD5 = 0x0065;
    public const int KEY_NUMPAD6 = 0x0066;
    public const int KEY_NUMPAD7 = 0x0067;
    public const int KEY_NUMPAD8 = 0x0068;
    public const int KEY_NUMPAD9 = 0x0069;
    public const int KEY_NUMPAD_MULTIPLY = 0x006A;
    public const int KEY_NUMPAD_ADD = 0x006B;
    public const int KEY_NUMPAD_ENTER = 0x006C;
    public const int KEY_NUMPAD_SUBTRACT = 0x006D;
    public const int KEY_NUMPAD_DEL = 0x006E;
    public const int KEY_NUMPAD_DIVIDE = 0x006F;

    //功能键
    public const int KEY_F1 = 0x0070;
    public const int KEY_F2 = 0x0071;
    public const int KEY_F3 = 0x0072;
    public const int KEY_F4 = 0x0073;
    public const int KEY_F5 = 0x0074;
    public const int KEY_F6 = 0x0075;
    public const int KEY_F7 = 0x0076;
    public const int KEY_F8 = 0x0077;
    public const int KEY_F9 = 0x0078;
    public const int KEY_F10 = 0x0079;
    public const int KEY_F11 = 0x007A;
    public const int KEY_F12 = 0x007B;
    public const int KEY_F13 = 0x007C;
    public const int KEY_F14 = 0x007D;
    public const int KEY_F15 = 0x007E;
    public const int KEY_F16 = 0x007F;

    //符号键
    public const int KEY_SYMBOL1 = 0x00BA; // ;:
    public const int KEY_SYMBOL2 = 0x00BB; // =+
    public const int KEY_SYMBOL3 = 0x00BC; // ,<
    public const int KEY_SYMBOL4 = 0x00BD; // -_
    public const int KEY_SYMBOL5 = 0x00BE; // .>
    public const int KEY_SYMBOL6 = 0x00BF; // /?
    public const int KEY_SYMBOL7 = 0x00C0; // `~
    public const int KEY_SYMBOL8 = 0x00DB; // [{
    public const int KEY_SYMBOL9 = 0x00DC; // |\
    public const int KEY_SYMBOL10 = 0x00DD; // ]}
    public const int KEY_SYMBOL11 = 0x00DE; // '"
}
public class KeyCodeStr
{
    private static Dictionary<int, string> m_keyCodeStr = new Dictionary<int, string>()
    {
        [0x0025] = "←",
        [0x0026] = "↑",
        [0x0027] = "→",
    ...
    {
        if(m_keyCodeStr.ContainsKey(keyCode))
        {
            return m_keyCodeStr[keyCode];
        }
        return null;
    }
}
...
{
    public const int KEY_DOWN = 1;//按下
    public const int KEY_UP = 2;//释放
}
