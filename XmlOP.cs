...
public class XmlOp
{
    ...
    {
        m_filePath = Application.StartupPath + "\\按键配置.xml";
    ...
    public void SetOrAddXmlAttributValue(string name, string value, XElement xElement = null , bool save = true)
    {
        if (xElement == null)
            xElement = xml;
    ...
    /// 添加要素
    /// </summary>
    public XElement AddXmlElement(string name,string value , XElement parent = null,bool save = true)
    {
        if (parent == null)
            parent = xml;
